...
<form method="GET" action="{{ route('shop') }}" class="shop-filters-form space-y-1">
    ...
    <div x-data="{ open: true }" class="shop-filter-section">
        ...
        <div x-ref="panel" :style="'max-height:' + (open ? $refs.panel.scrollHeight : 0) + 'px'" class="shop-filter-section-wrap">
            <div class="shop-filter-section-body">
    ...
    <div x-data="{ open: false }" class="shop-filter-section">
        ...
        <div x-ref="panel" :style="'max-height:' + (open ? $refs.panel.scrollHeight : 0) + 'px'" class="shop-filter-section-wrap">
            <div class="shop-filter-section-body shop-filter-section-body--scroll">
                <label class="shop-filter-option">
    ...
    <div class="shop-filter-actions">
        <button type="submit" class="btn-storefront-primary w-full min-h-[44px]">Apply Filters</button>
        <a href="{{ route('shop') }}" class="btn-storefront-secondary w-full min-h-[44px] text-center">Clear All</a>
    </div>
</form>
